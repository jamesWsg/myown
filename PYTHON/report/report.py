...
def process_all_node_network(filename,nodes):
    ...
    for node in nodes:
        try:
            ...
            #logging.error("call trace:{}".format(traceback.format_exc()))
...
def main(argv=None):
    ...
    nodes=['10.10.10.10','10.10.10.11','10.10.10.13']
    ...
    with open('clustercheck.result.detail','r') as f:
        data = json.load(f)        
